            ...
            <div class="flex flex-row items-center justify-between mx-auto p-4">
                ...
                <div class="hidden w-full md:block md:w-auto" id="navbar_button">
                    <ul class="font-semibold flex flex-col p-4 md:p-0 mt-4 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0">
                        <li>
                            <a href="#" class="block py-2 px-3 hover:text-white text-[30px] md:p-0" id="beranda">Beranda</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-3 text-black rounded-none hover:text-white text-[30px] md:p-0 " id="daftar_ruangan">Daftar Ruangan</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 px-3 text-black rounded-none text-white border-b-[2px] border-white text-[30px] md:p-0" id="daftar_peminjaman">Daftar Pesan</a>
                        </li>
                        <li>
            ...
            <div class="bg-white p-4 rounded-lg shadow-lg mt-[50px]">
                ...
                <div class="grid grid-cols-3 gap-4">
                    <div>
                        ...
                        <select id="nrp" class="mt-1 block w-full pl-3 pr-10 py-2 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            <option>NRP Peminjam</option>
                        </select>
                    </div>
                    <div>
